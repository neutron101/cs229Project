...
model_selector_params = {
					     ...
					     'BackwardSelector' : {'feature_file' : 'target_features_11_18_23_combined'}, \
					     
					     'FixedSetSelector' : {'feature_file': '../output/BEST_model___SVM_kernel=rbf,_C=7.0,_coef0=0.0,_degree=0.0,_gamma=0.1_Backward_Selector_0_genes	'}, \

					     'SkipOneFeatureSelector' : {'_iter' : ({"feature_file":"random_selected_features_1", "index":i} for i in range(23))}}

model_classifier_params = { 'SVM' : [{'kernel': 'rbf', 'C': 7, 'gamma': .1}] }
...
test_selector_params = { 'FixedSetSelector' : {'feature_file': '../output/BEST_model___SVM_kernel=rbf,_C=7.0,_coef0=0.0,_degree=0.0,_gamma=0.1_Backward_Selector_0_genes'} }
