...
model_selector_params = {
					     ...
					     'FixedSetSelector' : {'feature_file' : '../gene_set/unionall_reduced'}, \
...
model_classifier_params = {'SVM' : [{'kernel': 'poly', 'C': 1, 'coef0':7, 'gamma':.1, 'degree':2}]}
...
test_selector_params = { 'FixedSetSelector' : {'feature_file': '../gene_set/unionall'} }


test_classifier_params = {'SVM' : [{'kernel': 'poly', 'C': 1, 'coef0':7, 'gamma':.1, 'degree':2}]}
